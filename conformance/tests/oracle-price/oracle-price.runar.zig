...
pub const OraclePriceFeed = struct {
    ...
    pub fn init(oraclePubKey: runar.RabinPubKey, receiver: runar.PubKey) OraclePriceFeed {
        return .{ .oraclePubKey = oraclePubKey, .receiver = receiver };
    }

    pub fn settle(self: *const OraclePriceFeed, price: i64, rabinSig: runar.RabinSig, padding: runar.ByteString, sig: runar.Sig) void {
