...
pub const SPHINCSWallet = struct {
    ...
    pub fn init(ecdsaPubKeyHash: runar.Addr, slhdsaPubKeyHash: runar.ByteString) SPHINCSWallet {
        return .{ .ecdsaPubKeyHash = ecdsaPubKeyHash, .slhdsaPubKeyHash = slhdsaPubKeyHash };
    }

    pub fn spend(self: *const SPHINCSWallet, slhdsaSig: runar.ByteString, slhdsaPubKey: runar.ByteString, sig: runar.Sig, pubKey: runar.PubKey) void {
