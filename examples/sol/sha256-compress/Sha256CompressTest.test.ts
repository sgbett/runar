...
const source = readFileSync(join(__dirname, 'Sha256CompressTest.runar.sol'), 'utf8');
const FILE_NAME = 'Sha256CompressTest.runar.sol';
...
describe('Sha256CompressTest (Solidity)', () => {
  it('sha256Compress succeeds with correct state and block', () => {
