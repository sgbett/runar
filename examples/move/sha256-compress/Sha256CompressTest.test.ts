...
const source = readFileSync(join(__dirname, 'Sha256CompressTest.runar.move'), 'utf8');
const FILE_NAME = 'Sha256CompressTest.runar.move';
...
describe('Sha256CompressTest (Move)', () => {
